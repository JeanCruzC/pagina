#!/usr/bin/env python3
"""
Test simple para verificar que el scheduler funciona correctamente.
"""
...
from website import scheduler as sched_module
    ...
    with app.app_context():
        ...
        for dia in range(1, 8):  # Días 1-7
            for hora in range(24):  # Horas 0-23
                ...
                if 8 <= hora <= 17:
                    demanda = 5 if dia <= 5 else 2  # Más demanda en días laborales
                else:
                    demanda = 1
